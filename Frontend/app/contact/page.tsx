  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center py-16 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src="/Aboutus.jpg" // your image in /public folder
          alt="Background"
          ...
          <form className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-indigo-900 text-white py-4 rounded-xl font-semibold text-lg 
                         hover:bg-white hover:text-indigo-900 hover:shadow-2xl transition-all duration-500 cursor-pointer transform hover:scale-105"
            >
              Send Message
            </button>
          </form>
