...
export default function TickerBanner() {
  return (
    <div className="fixed top-2 z-50 w-full bg-gradient-to-r from-indigo-900 via-indigo-800 to-indigo-700 text-white overflow-hidden shadow-2xl border-t-2 border-indigo-600 border-b-2 rounded-3xl">
